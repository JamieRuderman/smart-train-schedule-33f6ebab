  ...
  southbound: {
    am: [
      ...
      },
      {
        ...
        ferry: { depart: "9:25", arrive: "10:00" },
      },
      {
        trip: 15,
        times: [
        ...
        ferry: { depart: "10:10", arrive: "10:45" },
      },
      {
        trip: 17,
        times: [
        ...
        ferry: { depart: "11:50", arrive: "12:25" },
      },
      {
        trip: 19,
        times: [
    ...
    am: [
      {
        ...
        ferry: { depart: "9:00", arrive: "10:00" },
      },
      {
        trip: 3,
        times: [
        ...
        ferry: { depart: "10:00", arrive: "10:35" },
      },
      {
        trip: 5,
        times: [
        ...
        ferry: { depart: "11:30", arrive: "12:05" },
      },
    ],
    pm: [
      {
  ...
  northbound: {
    am: [
      ...
      },
      {
        ...
        ferry: { depart: "10:45", arrive: "11:20" },
      },
    ],
    pm: [
      {
        ...
        ferry: { depart: "12:15", arrive: "12:50" },
      },
      {
        trip: 10,
        times: [
      ...
      },
      {
        ...
        ferry: { depart: "6:45", arrive: "7:20" },
      },
    ],
  },
};

// Define types for the schedule data structures
...
// Helper to determine if a time string is AM or PM for a given trip, using the am/pm arrays
...
// Update formatTime to use period from data structure
...
// Update isTimeInPast to use period from data structure
const isTimeInPast = (
